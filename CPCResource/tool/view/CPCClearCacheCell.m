...
@implementation CPCClearCacheCell
...
//        __weak XMGClearCacheCell * weakSelf = self;
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            // 获得缓存文件夹路径
            unsigned long long size = c_CustomCacheFile.c_fileSize;
...
- (void)clearCache
{
    ...
    [[SDImageCache sharedImageCache] clearDiskOnCompletion:^{
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            [mgr removeItemAtPath:c_CustomCacheFile error:nil];
            [mgr createDirectoryAtPath:c_CustomCacheFile withIntermediateDirectories:YES attributes:nil error:nil];
