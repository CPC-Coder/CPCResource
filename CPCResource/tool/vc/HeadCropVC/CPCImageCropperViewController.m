...
@interface CPCImageCropperViewController ()
...
@implementation CPCImageCropperViewController
...
- (void)initView {
    ...
    //上下蒙版
    UIView* v1=[[UIView alloc] initWithFrame:CGRectMake(0, 0, oriWidth, _cropFrame.origin.y)];
    v1.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.7];
    CGFloat y=CGRectGetMaxY(_cropFrame);
    [self.view addSubview:v1];
    
    UIView* v2=[[UIView alloc] initWithFrame:CGRectMake(0,y , oriWidth,self.view.frame.size.height-y )];
    v2.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.7];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(CPCImageCropperViewControllerDelegate)]) {
...
#pragma mark -
#pragma mark 此方法是为了将图片变形到适应ratioView
